 ...
 * Class 의 method 들의 각각의 Routing 이 되어 응답을 처리한다
 * 
...
public class UserController {
	...
	public String login() {
		 ...
		 * WEP-INF/views 폴더에서 `문자열`.jsp 파일을 찾아서
		 * rendering 한 후 Response 를 한다.
		 * 
		 *  그런데 method 에서 null 을 return 하면
		 *  자신이 요청받은 Request Routing 주소를 문자열로 return 한것돠
		 *  똑같이 작동한다
